...
namespace Entity
{
    public class Car
    {
        ...
        public void DrawRoad(Graphics g)
        {
              ...
              Pen p06 = new Pen(Color.Brown, 65);
              Pen p07 = new Pen(Color.Wheat, 3);
            ...
            //Rode lamp:
              ...
              g.DrawLine(p03, new Point(210, 440), new Point(172, 465));
              g.DrawLine(p03, new Point(130, 440), new Point(168, 465));
              g.DrawLine(p03, new Point(95, 430), new Point(108, 455));
              g.DrawLine(p03, new Point(120, 455), new Point(165, 465));
              g.DrawLine(p03, new Point(170, 420), new Point(172, 465));
              g.DrawLine(p03, new Point(80, 430), new Point(87, 475));
              g.DrawLine(p03, new Point(55, 445), new Point(87, 480));
              //new:
              g.FillEllipse(Brushes.Red, 178, 425, 12, 12);// circle 
              g.FillEllipse(Brushes.Pink, 118, 415, 12, 12);//circle 
              g.FillEllipse(Brushes.Yellow, 148, 415, 12, 12);//circle 
              g.FillEllipse(Brushes.Red, 88, 415, 12, 12);// circle 
              g.FillEllipse(Brushes.Yellow, 58, 420, 12, 12);//circle 
              g.FillEllipse(Brushes.Pink, 190, 432, 12, 12);//circle 
              g.FillEllipse(Brushes.Yellow, 205, 435, 12, 12);//circle 
              g.FillEllipse(Brushes.Yellow, 180, 435, 12, 12);//circle 
              g.FillEllipse(Brushes.Red, 195, 445, 12, 12);//circle 
              g.FillEllipse(Brushes.Red, 128, 435, 12, 12);//circle 
              g.FillEllipse(Brushes.White, 138, 442, 12, 12);//circl 
              g.FillEllipse(Brushes.Yellow, 95, 430, 12, 12);//circl 
              g.FillEllipse(Brushes.Yellow, 115, 450, 12, 12);//circl 
              g.FillEllipse(Brushes.Red, 128, 452, 12, 12);//circl 
              g.FillEllipse(Brushes.Pink, 168, 417, 12, 12);//circl 
              g.FillEllipse(Brushes.White, 75, 425, 12, 12);// circle 
              g.FillEllipse(Brushes.White, 45, 440, 12, 12);// circle 
              //pata
              g.FillEllipse(Brushes.Green, 170, 470, 12, 12);//circle 
              g.FillEllipse(Brushes.Green, 175, 470, 12, 12);//circle 
              g.FillEllipse(Brushes.Green, 155, 470, 12, 12);//circle 
              g.FillEllipse(Brushes.Green, 150, 470, 12, 12);//circle
              g.FillEllipse(Brushes.Green, 160, 470, 12, 12);//circle 
              g.FillEllipse(Brushes.Green, 90, 470, 15, 15);//circle
              g.FillEllipse(Brushes.Green, 80, 470, 15, 15);//circle 

              //Dastbin:
              g.DrawLine(p06, new Point(1120, 415), new Point(1110, 500));
              g.DrawLine(p06, new Point(1100, 415), new Point(1110, 500));
              //white Dhakna:-
              g.DrawLine(p07, new Point(1100, 430), new Point(1110, 430));
              g.DrawLine(p07, new Point(1125, 430), new Point(1105, 430));
              g.DrawLine(p07, new Point(1125, 440), new Point(1105, 440));
              g.DrawLine(p07, new Point(1100, 440), new Point(1110, 440));
              g.DrawLine(p07, new Point(1100, 430), new Point(1100, 440));
              g.DrawLine(p07, new Point(1125, 440), new Point(1125, 430));
